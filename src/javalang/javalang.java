...
public class javalang {
    ...
    public static void printCalendar(Calendar cal, boolean Korean) {
        ...
        int month=month=cal.get(Calendar.MONTH)+1;
        ...
        if(Korean) {
            ...
            switch(dayOfWeek){
                ...
                case Calendar.THURSDAY : sb.append("Thur. ");break;
    ...
    public static void main(String[] args) {
        ...
        // TODO: input 문자열의 숫자를 모두 합하여 sum에 넣기. ok
        System.out.println("sum:" + sum);

        // TODO: input2 문자열에서 .을 !로 바꾸기 ok
        // Hint: String.replace()
        String new_input2 = input2.replace(".","!"); // 이 부분을 고칠 것.
        System.out.println(new_input2);

        // TODO: 아래 문장 수행결과로 HelloJava 가 출력되도록 class javalng에 메소드를 추가하기. ok
